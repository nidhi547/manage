...
<body style="background-color:#e8505b">

   
    <h5 align="right" style="margin-top:20px"><a href="index.php">Admin Login</a></h5>
  <h1 align="center"> WELCOME TO MANAGEMENT SYSTEM </h1>
    
    <form method="post" action="home.php">
    <table align="center" border="3" style="margin-top:70px">
        <tr>
